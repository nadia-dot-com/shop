import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{L as c}from"./LoadingSpinner-CYNmS32I.js";import{E as m}from"./ErrorState-D0hai8nb.js";import"./index.es-CzsuQdpM.js";import"./iframe-CZdCOPjp.js";import"./preload-helper-PPVm8Dsz.js";const g=e=>{if(e)return e};function d({loading:e,loaded:t,error:i,children:l}){const s=g(i);return r.jsxs(r.Fragment,{children:[e&&r.jsx(c,{}),s&&r.jsx(m,{message:s.message}),t&&l]})}d.__docgenInfo={description:"",methods:[],displayName:"DataLoader"};const j={component:d,decorators:[e=>r.jsx("div",{style:{padding:40},children:r.jsx(e,{})})]},o={args:{loading:!0,loaded:!1,error:null,children:r.jsx("div",{children:"Content"})}},n={args:{loading:!1,loaded:!0,error:null,children:r.jsx("div",{children:"Content"})}},a={args:{loading:!1,loaded:!1,error:new Error("Something went wrong"),children:r.jsx("div",{children:"Content"})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    loading: true,
    loaded: false,
    error: null,
